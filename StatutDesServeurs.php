    ...
    <main>
        <section class="server-grid">
            <div class="server-info" id="server-rouen">
                <img src="images/rouen.jpg" alt="Icone Serveur Rouen" class="server-icon">
            ...
            <div class="server-info" id="server-monaco">
                <img src="images/monaco.jpg" alt="Icone Serveur Monaco" class="server-icon">
            ...
            <div class="server-info" id="server-paris">
                <img src="images/paris.jpg" alt="Icone Serveur Paris" class="server-icon">
            ...
            <div class="server-info" id="server-mq">
                <img src="images/montcuq.jpg" alt="Icone Serveur MQ" class="server-icon">
