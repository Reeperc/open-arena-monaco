...
<head>
  ...
  <style>
    ...
    .image-container img {
      margin: 35px;
      /* Ajoutez un espace entre les images si nécessaire */
      width: 550px;
      /* Définissez la largeur souhaitée (par exemple, 100px) */
      height: auto;
      /* La hauteur est automatiquement ajustée pour maintenir les proportions */
    }
    ...
    .content {
      flex: 1;
      /* Occupe tout l'espace restant à gauche */
    }
  </style>
</head>
