...
$command = "sshpass -p 'quake' ssh -o StrictHostKeyChecking=no quake@195.221.30.65 'openarena-server +set dedicated 1 +set net_port 27961 +set g_gametype 1 +map delta +set sv_hostname \"Tournois Monaco\"'";
