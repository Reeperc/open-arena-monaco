...
<body>
    ...
    <?php require_once('script_vainqueur_quart.php'); ?>
                    ...
                    <a href="javascript:void(0);">
                        <div class="member-view-box">
                            <div class="member-image">
                                <img src="images/akalogo.png" alt="Member">
                                <div class="member-details">
                                    <?php script_premier_demi();
                                    print(" VS ");
                                    script_second_demi(); ?>
                                </div>
                                <form method='post' action=''>
                                    <p><?php script_premier_demi(); ?> : <input type='number' name='score_1_1001' style="width: 50px;"><br></p>
                            ...
                            <a href="javascript:void(0);">
                                <div class="member-view-box">
                                    <div class="member-image">
                                        <img src="images/akalogo.png" alt="Member">
                                        <div class="member-details">
                                            <?php script_vainqueur_quart($match_id = 977);
                                            print(" VS ");
                                            script_vainqueur_quart($match_id = 979); ?>
                                        </div>
                                        <form method='post' action=''>
                                            <p><?php script_vainqueur_quart($match_id = 977); ?> : <input type='number' name='score_1_995' style="width: 50px;"><br></p>
                                            <p><?php script_vainqueur_quart($match_id = 979); ?> : <input type='number' name='score_2_995' style="width: 50px;"><br></p>
                                        ...
                                        <?php if ($_POST['separator'] == 995) {
                                            ...
                                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                ...
                                                $equipe1 = script_vainqueur_quart($match_id = 977);
                                                $equipe2 = script_vainqueur_quart($match_id = 979);
                                            }
                            ...
                            <a href="javascript:void(0);">
                                <div class="member-view-box">
                                    <div class="member-image">
                                        <img src="images/akalogo.png" alt="Member">
                                        <div class="member-details">
                                            <?php script_vainqueur_quart($match_id = 978);
                                            print(" VS ");
                                            script_vainqueur_quart($match_id = 980); ?>
                                        </div>
                                        <form method='post' action=''>
                                            <p><?php script_vainqueur_quart($match_id = 978); ?> : <input type='number' name='score_1_996' style="width: 50px;"><br></p>
                                            <p><?php script_vainqueur_quart($match_id = 980); ?> : <input type='number' name='score_2_996' style="width: 50px;"><br></p>
                                        ...
                                        <?php if ($_POST['separator'] == 996) {
                                            ...
                                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                ...
                                                $equipe1 = script_vainqueur_quart($match_id = 978);
                                                $equipe2 = script_vainqueur_quart($match_id = 980);
                                            }
                                        ...
                                        <div class="member-view-box">
                                            <div class="member-image">
                                                ...
                                                <div class="member-details">
                                                    ...
                                                    print(" VS ");
                                                    script_selecion_second_poule($poule = "B"); ?>
                                                </div>
                                                <form method='post' action=''>
                                                    <p><?php script_selecion_vainqueur_poule($poule = "A"); ?> : <input type='number' name='score_1_977' style="width: 50px;"><br></p>
                                        ...
                                        <div class="member-view-box">
                                            <div class="member-image">
                                                ...
                                                <div class="member-details">
                                                    ...
                                                    print(" VS ");
                                                    script_selecion_vainqueur_poule($poule = "B"); ?>
                                                </div>
                                                <form method='post' action=''>
                                                    <p><?php script_selecion_second_poule($poule = "A"); ?> : <input type='number' name='score_1_978' style="width: 50px;"><br></p>
                                                    <p><?php script_selecion_vainqueur_poule($poule = "B"); ?> : <input type='number' name='score_2_978' style="width: 50px;"><br></p>
                                        ...
                                        <div class="member-view-box">
                                            <div class="member-image">
                                                ...
                                                <div class="member-details">
                                                    ...
                                                    print(" VS ");
                                                    script_selecion_second_poule($poule = "D"); ?>
                                                </div>
                                                <form method='post' action=''>
                                                    <p><?php script_selecion_vainqueur_poule($poule = "C"); ?> : <input type='number' name='score_1_979' style="width: 50px;"><br></p>
                                        ...
                                        <div class="member-view-box">
                                            <div class="member-image">
                                                ...
                                                <div class="member-details">
                                                    ...
                                                    print(" VS ");
                                                    script_selecion_second_poule($poule = "C"); ?>
                                                </div>
                                                <form method='post' action=''>
                                                    <p><?php script_selecion_vainqueur_poule($poule = "D"); ?> : <input type='number' name='score_1_980' style="width: 50px;"><br></p>
                                                    <p><?php script_selecion_second_poule($poule = "C"); ?> : <input type='number' name='score_2_980' style="width: 50px;"><br></p>
                                                ...
                                                <?php if ($_POST['separator'] == 980) {
                                                    ...
                                                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                        ...
                                                        $equipe1 = script_selecion_vainqueur_poule($poule = "D");
                                                ...
                                                <div class="member-view-box">
                                                    <div class="member-image">
                                                        ...
                                                        <?php if ($_POST['separator'] == 953) {
                                                            ...
                                                            script_competition($score1, $score2, $equipe1 = "A_1", $equipe2 = "A_2", $poule = "A", $match_ids = 953);
                                                        }
                                                ...
                                                <div class="member-view-box">
                                                    <div class="member-image">
                                                        ...
                                                        <?php if ($_POST['separator'] == 954) {
                                                            ...
                                                            script_competition($score1, $score2, $equipe1 = "A_1", $equipe2 = "A_3", $poule = "A", $match_ids = 954);
                                                        }
                                                        ?>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="member-view-box">
                                                    <div class="member-image">
                                                        ...
                                                        <?php if ($_POST['separator'] == 976) {
                                                            ...
                                                            script_competition($score1, $score2, $equipe1 = "D_3", $equipe2 = "D_4", $poule = "D", $match_ids = 976);
                                                        }
                                                        ?>
                                                    </div>
                                                </div>
