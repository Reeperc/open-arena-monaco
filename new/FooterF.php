<footer>
    <article>
        ...
        <h3>Remerciements</h3>
        <p>Merci bien évidemment à Aurélien, Antoine, Auriace, Baptiste et Taher et pour leur soutien infaillible dans cette mission, et pour leur dévouement sur la configuration du serveur !</p>
